...
<body>
  <main style="max-width:480px;margin:24px auto;padding:12px;">
    ...
    <form id="reset-form">
      ...
      <div class="form-row"><label>Nueva contraseña<br><input name="password" type="password" required minlength="8"></label></div>
      <div class="form-row"><label>Confirmar contraseña<br><input name="confirm" type="password" required minlength="8"></label></div>
      <div class="form-row"><button type="submit">Restablecer contraseña</button> <a href="/Sabores360/views/auth/login.php">Volver a iniciar sesión</a></div>
    </form>
  </main>
